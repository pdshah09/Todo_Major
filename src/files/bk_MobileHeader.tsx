...
export default function MobileHeader() {
  ...
  return (
    <>
      <header className="flex items-center justify-between border-b border-border-light bg-foreground px-4 py-3 md:hidden">
      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden">
          <div className="absolute inset-0 bg-foreground" onClick={() => setOpen(false)} />
