...
export default function NotFound() {
  return (
    <main className="grid min-h-screen bg-zinc-100 place-items-center px-2 py-24 sm:py-12 lg:px-6 selection:bg-foreground selection:text-black">
      ...
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            href="/"
            className="rounded-full bg-brand px-6 py-2.5 text-sm font-medium text-main shadow-sm hover:bg-canvas transition-all duration-200 active:scale-95"
          >
            Back to home
          </Link>
        </div>
