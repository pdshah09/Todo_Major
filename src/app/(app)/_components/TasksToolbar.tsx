    ...
    <div ref={toolbarRef} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
      ...
      <div className="relative w-full flex-1">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-1.5 text-sm bg-card rounded-md focus:outline-none focus:border-brand text-text-subtle placeholder:text-text-subtle shadow-md"
        />
      </div>
      ...
      <div className="flex items-center gap-2 self-end sm:self-auto">
        ...
        <div className="relative">
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md transition-colors
              ${activeFilterCount > 0 ? "bg-brand/20 text-brand" : "text-text-subtle hover:bg-brand-light"}`}
          >
        ...
        {currentUserIsAdmin && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium bg-brand text-bg-card rounded-md hover:opacity-80 transition-opacity"
          >
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-text-main hover:bg-brand-light rounded-md transition-colors"
          >
              ...
              {([
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-1.5 text-[13px] transition-colors
                    ${sort === key ? "text-brand font-semibold" : "text-text-main hover:bg-brand-light"}`}
                >
                  {label}
                </button>
              ))}
