...
export default function ConnectPage() {
  ...
  return (
    <div className="min-h-[100%] text-white flex items-center justify-center p-6">
      <div className="bg-canvas border border-white/10 rounded-2xl p-8 w-full max-w-sm flex flex-col items-center gap-6 shadow-2xl">
        ...
        >
          {loading === '__new__' ? (
            ...
            <span className="text-card leading-none mr-0.5">+ CONNECT NEW</span>
          )}
        </button>
